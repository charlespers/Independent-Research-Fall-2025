...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/misc/1laser_0p0012kappa_10ns_18mA_intensity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/misc/1laser_0p0012kappa_10ns_18mA_carrierdensity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/misc/1laser_0p012kappa_10ns_18mA_intensity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/misc/1laser_0p12kappa_10ns_22mA_intensity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/misc/2laser_0p012kappa_10ns_intercouple_0p012kappa_50ns_l0selfcouple_17mA_intensity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment3/1laser_uncoupled_intensity_vs_current_fine.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/misc/bigunwantedspikes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment4/1laser_switched_fast_0p01shiftratio_0kappa_0ns_threshold_carrierdensity.png}
\caption{Carrier density after a injection current change with ``shift\textunderscore ratio" = 0.01}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment4/1laser_switched_fast_0p1shiftratio_0kappa_0ns_threshold_carrierdensity.png}
\caption{Carrier density after a injection current change with ``shift\textunderscore ratio" = 0.1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment4/1laser_switched_fast_1shiftratio_0kappa_0ns_threshold_carrierdensity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment2/1laser_1kappa_1ns_threshold_intensity.png}
\caption{Intensity for a self-coupled laser w/ $\kappa = 1$, $\tau = 1$ns, driven at threshold current.\label{chaoticoscdied}}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment2/1laser_1kappa_1ns_threshold_intensity_filtered.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment2/1laser_0p5kappa_1ns_threshold_intensity.png}
\caption{Intensity for a self-coupled laser w/ $\kappa = 0.5$, $\tau = 1$ns, driven at threshold current.\label{chaoticoscdied}}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment2/1laser_0p5kappa_1ns_threshold_intensity_filtered.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/1laser/experiment2/1laser_0p01kappa_1ns_threshold_intensity_filtered.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{results/2laser/experiment2/intensity_vs_current_for_0p1kappa_0tau_external_injection.png}
...
\begin{itemize}
    \item Plot the above graph on a log log plot
    \item Plot this above graph vs. coupling strength
    \item expand into 4 lasers for flower dataset
\end{itemize}

\section{July 18, 2025}
Things to do:

\begin{itemize}
    \item Add Langevin (random noise) to simulation model
    \item Consider solving steady state equations to make simulations faster
\end{itemize}

\section{July 25, 2025}
\begin{itemize}
    \item See Ohtsubo pg. 44 for separation of amplitude and phase, as well as why some texts use 1 + $\alpha$.
    \item Finished coding steady state solver. Previously not all simulations were converging since we were breaking the E field into real and imaginary parts still. But now we get rid of alpha and just look at the amplitude and it works.
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{ss_results/2laser/experiment2/amplitudeEfield/intensity_vs_current_for_0p1kappa_0tau_external_injection_ss (2).png}
\caption{Same graph as ~\ref{intensityvcurrentexternalinjection} except obtained using the steady state solver. Intensity vs. Current curves for a laser coupled to an external laser. Different injection values of the external laser are simulated, which change the curve's characteristics. \label{intensityvcurrentexternalinjectionss}}
\end{figure}

Note that the curves differ slightly from the results of the time domain simulator. I wonder why.
